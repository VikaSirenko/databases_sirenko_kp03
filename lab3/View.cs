...
public class View
{
    ...
    private static void DoActionsWithUsersTable(Controller controller)
    {
        ...
        WriteLine("What do you want to do with the user table?('add'/ 'delete' / 'edit')");
    ...
    {
        WriteLine("What do you want to do with the messages table?('add'/ 'delete' / 'edit')");
        string command = ReadLine();
        if (command == "add")
        {
    ...
    {
        WriteLine("What do you want to do with the folder table?('add'/ 'delete' / 'edit')");
        string command = ReadLine();
        if (command == "add")
        {
